...
import slide2 from "../assets/images/gallery-19.jpg";
...
import slide6 from "../assets/images/gallery-20.jpg";
...
import slide13 from "../assets/images/gallery-18.jpg";
    ...
    <div className="">
      ...
      <div className="p-5 md:p-[100px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
          ...
          <div className="rounded overflow-hidden">
            <img src={slide13} alt="" className="w-full" />
          </div>
